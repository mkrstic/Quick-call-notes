...
/**
 * MySlidingDrawer hides content out of the screen and allows the user to drag a handle
 * to bring the content on screen. MySlidingDrawer can be used vertically or horizontally.
 *
 ...
 *
 * MySlidingDrawer should be used as an overlay inside layouts. This means MySlidingDrawer
 * should only be used inside of a FrameLayout or a RelativeLayout for instance. The
 * size of the MySlidingDrawer defines how much space the content will occupy once slid
 * out so MySlidingDrawer should usually use match_parent for both its dimensions.
 *
 * Inside an XML layout, MySlidingDrawer must define the id of the handle and of the
 * content:
 *
 ...
 * </pre>
 *
 * @attr ref android.R.styleable#MySlidingDrawer_content
 * @attr ref android.R.styleable#MyMySlidingDrawer_handle
 * @attr ref android.R.styleable#MyMySlidingDrawer_topOffset
 * @attr ref android.R.styleable#MyMySlidingDrawer_bottomOffset
 * @attr ref android.R.styleable#MyMySlidingDrawer_orientation
 * @attr ref android.R.styleable#MySlidingDrawer_allowSingleTap
 * @attr ref android.R.styleable#MySlidingDrawer_animateOnClick
 */
public class MySlidingDrawer extends ViewGroup {
    ...
    /**
     * Creates a new MySlidingDrawer from a specified set of attributes defined in XML.
     *
    ...
    public MySlidingDrawer(Context context, AttributeSet attrs, int defStyle) {
        ...
        int orientation = a.getInt(R.styleable.MySlidingDrawer_orientation, ORIENTATION_VERTICAL);
        ...
        mAllowSingleTap = a.getBoolean(R.styleable.MySlidingDrawer_allowSingleTap, true);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthSpecMode == MeasureSpec.UNSPECIFIED || heightSpecMode == MeasureSpec.UNSPECIFIED) {
            throw new RuntimeException("MySlidingDrawer cannot have UNSPECIFIED dimensions");
        }
